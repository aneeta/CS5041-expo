...
//                     <a className="sidebar-brand brand-logo" href="index.html"><img src={require("../../../assets/favicon.png")} alt="logo" /></a>
//                     <a className="sidebar-brand brand-logo-mini pt-3" href="index.html"><img src={require("../../../assets/favicon.png")} alt="logo" /></a>
//                 </div>
//                 <ul className="nav">
...
//                                             <img className="img-xs rounded-circle" src={require("../../../assets/favicon.png")} alt="profile" />
